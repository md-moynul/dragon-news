    ...
    return (
        <div className="min-h-[95vh] flex items-center bg-base-300">
            <form
                ...
                className="bg-base-100 border-base-300 rounded-box w-150  border py-10 px-15 space-y-4 mx-auto shadow-2xl">
                ...
                <fieldset className="space-y-4">
                    ...
                    <input type="text" name="photo_url" className="input w-full  border-none bg-base-300" placeholder="Enter your photo url" />
                </fieldset>
                <fieldset className="space-y-4">
